    ...
    public void keyPressed(KeyEvent e){
        int key = e.getKeyCode();
        {
            if(key == KeyEvent.VK_0){
                Keyboard.bool_0 = !Keyboard.bool_0;
            }
            if(key == KeyEvent.VK_1){
                Keyboard.bool_1 = !Keyboard.bool_1;
            }
            if(key == KeyEvent.VK_2){
                Keyboard.bool_2 = !Keyboard.bool_2;
            }
            if(key == KeyEvent.VK_3){
                Keyboard.bool_3 = !Keyboard.bool_3;
            }
            if(key == KeyEvent.VK_4){
                Keyboard.bool_4 = !Keyboard.bool_4;
            }
            if(key == KeyEvent.VK_5){
                Keyboard.bool_5 = !Keyboard.bool_5;
            }
            if(key == KeyEvent.VK_6){
                Keyboard.bool_6 = !Keyboard.bool_6;
            }
            if(key == KeyEvent.VK_7){
                Keyboard.bool_7 = !Keyboard.bool_7;
            }
            if(key == KeyEvent.VK_8){
                Keyboard.bool_8 = !Keyboard.bool_8;
            }
            if(key == KeyEvent.VK_9){
                Keyboard.bool_9 = !Keyboard.bool_9;
            }
